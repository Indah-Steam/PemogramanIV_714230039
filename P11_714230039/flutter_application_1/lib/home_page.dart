...
import 'user.dart';
import 'user_card.dart'; // Pastikan file UserCard di-import di sini
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Form(
        key: _formKey,
        child: SingleChildScrollView( // Mencegah overflow pada layar kecil
              ...
              Row(
                children: [
                  ...
                  _buildActionButton('PUT', () async {
                    ...
                    final res = await _dataService.putUser('3', _nameCtl.text, _jobCtl.text);
                    setState(() => _result = res.toString());
                    _nameCtl.clear();
                    _jobCtl.clear();
                  }),
  ...
  Widget _buildHasilCard() {
    if (usCreate == null) return const Center(child: Text('No data created yet'));
    return Center(
      child: UserCard(usrCreate: usCreate!),
    );
  }
}